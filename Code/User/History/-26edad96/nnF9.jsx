...
export const Footer = () => {
    return (
		<div className='bg-black text-white'>
			<div className='mx-auto max-w-[1100px] h-[35vh] mt-7'>
				<div className='flex flex-row space-x-3 justify-center'>
					<div className='basis-2/5'>
						<h1 className='font-bold py-4 text-lg'>Про нас</h1>
					...
					<div className='justify-center basis-1/5'>
						<h1 className='font-bold py-4 text-lg'>Наши социальные сети</h1>
					...
					<div className='flex flex-col space-y-2 basis-2/5'>
						<h1 className='font-bold py-4 text-lg'>Контакты</h1>
