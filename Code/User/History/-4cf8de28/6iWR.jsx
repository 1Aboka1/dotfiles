    ...
    return (
        <div className='bg-white'>
            <div className='max-w-[1020px] mx-auto h-screen'>
                <div className='flex justify-center mx-auto space-x-6 p-4 pt-7'>
                    ...
                    <div className='w-[500px] bg-gray-100 rounded-lg p-6 px-8 ring-1 ring-green-200 hover:ring-2 hover:ring-green-400 transition ease-in-out duration-300'>
                        ...
                        <span className='text-gray-700 font-normal text-sm inline-block '>{'Код товара: ' + productDetails.id}</span>
                        <p className='font-medium text-3xl '>₸{productDetails.price}</p>
                        <div className=''>
