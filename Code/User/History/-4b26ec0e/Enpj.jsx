            ...
            <div className={'h-screen bg-gray-500 bg-center bg-no-repeat bg-cover bg-blend-multiply'} style={{backgroundImage: `url("/mediafiles/6424672.jpg")`}}>
                <div className='flex flex-col items-center gap-6 justify-center h-[75vh] '>
                    ...
                    <div className='flex space-x-3 w-full justify-center'>
                        ...
                        <Link to={'search'}>
                            <button className='rounded-lg px-4 py-3 ring-0 ring-gray-300 bg-white font-bold hover:bg-gray-200 hover:ring-1 hover:ring-black hover:scale-110 transition ease-in-out duration-200'>Каталог</button>
                        </Link>
                    </div>
                </div>                
            </div>
