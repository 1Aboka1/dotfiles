    ...
    const renderSignUpWindow = () => {
        return (
            <div className='bg-gray-100 rounded-2xl w-[75vh]'>
                ...
                <div className='flex flex-row justify-center py-7 border-t border-gray-300'>
                    <p onClick={handleAlreadyHaveAccount} className='cursor-pointer text-green-500 hover:text-green-600 transition ease-in-out duration-300'>Уже есть аккаунт? Войти</p>
                </div>
            </div>
        )
    }
