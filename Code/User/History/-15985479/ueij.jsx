            ...
            <div className='mx-auto max-w-[1100px] pt-4'>
                <div className='flex justify-between items-center py-4'>
                    ...
                    <div className='flex space-x-4 h-10'>
                        <form className='ring-1 ring-gray-300 bg-gray-100 rounded-lg outline-none p-3 space-x-2 pr-2 flex items-center border focus-within:border-green-500 hover:scale-105 focus-within:scale-105 transition duration-200'>
                        ...
                        <div className='flex rounded-lg ring-1 ring-gray-300'>
                            <button className={(listView ? 'bg-gray-300 ' : '') + 'flex items-center px-[10px] ring-1 ring-gray-300 rounded-l-lg focus:ring-green-300 focus:ring-2 transition ease-in-out duration-400 hover:bg-gray-200'} onClick={handleListClick}>
                                <MenuOutlinedIcon fontSize='small'/>
                            </button>
                            <button className={(listView ? '' : 'bg-gray-300 ') + 'flex items-center px-[10px] ring-1 ring-gray-300 rounded-r-lg focus:ring-green-300 focus:ring-2 transition ease-in-out duration-400 hover:bg-gray-200'} onClick={handleGridClick}>
